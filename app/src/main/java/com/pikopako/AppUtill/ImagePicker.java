...
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        //modified for oreo
        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(context,"com.pikopako.fileProvider",getTempFile(context)));
...
//                selectedImage = Uri.fromFile(imageFile);
                //modified for oreo
                selectedImage = FileProvider.getUriForFile(context,"com.pikopako.fileProvider",imageFile);
            }
            else {            /** ALBUM **/
