...
public class My_Favourites_list extends BaseActivity {
    ...
    My_favourite_list_Adapter my_favourite_list_adapter;
    String language="";
    @Override
    ...
    private void listners() {
        ...
        mTitle.setText(R.string.string_myfavourites);
                ...
                if (jsonObject != null) {
                    try {
                        ...
                        if(jsonObject1.getString("status").equalsIgnoreCase(Constant.SUCCESS)) {
                            ...
                            recyclerView.setLayoutManager(new LinearLayoutManager(My_Favourites_list.this));
                            my_favourite_list_adapter=new My_favourite_list_Adapter(My_Favourites_list.this,categoriesArray);
                            ...
                            if (jsonObject1.getString("message").equalsIgnoreCase("Session expired.")){
                                Intent intent=new Intent(My_Favourites_list.this,LoginActivity.class);
